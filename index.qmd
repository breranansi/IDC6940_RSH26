...
and we were quite disappointed when $\beta_{06}\neq 0$.

This suggested to us that the regularization *was* needed when vanilla linear regression is used for symbolic regression.
