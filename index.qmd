...
We may want to consider additional binary operators such as the power function ($a^b$) or the maximum or minimum functions.
...
In our case, we may want to consider logarithm and exponential functions.
