...
A comment connecting health stuff to molecular mass goes here
</p>
...
<p style="color:Tomato">Description of health stuff dataset goes here</p>
...
: Partial List of Addditional Operators {#tbl-ope-add .striped .hover}
...
+----------+----------+----------+------------+----------+--------------+
|          | Raw\     | Default\ | Goossens\  | Power\   | Exponential\ |
|          | Mw       | Run      | Correlation| Run      | Run #2       |
+:=========+=========:+=========:+===========:+=========:+=============:+
