...
$a_{00} \cdot a_{01}^{SG^{-a_{02}} + a_{03} TBP} + a_{04}$
...
One can argue that nested exponents $(a^{b^c})$ aren't very explainable.  However the Stratiev correlation does this with Euler's number $\left ( a \cdot e^{b \cdot e^{c}} \right )$.
