...
hist(df$SG,
     ...
     col="lightgreen")
```
This distribution is skewed to the right, but not as strongly as molecular mass.  No signs of a bimodal distribution here.  Let take a peek at the box plot:
