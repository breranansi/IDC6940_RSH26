...
One can argue that nested exponents $(a^{b^c})$ aren't very explainable.  However the Stratiev correlation does this with Euler's number $\left ( a \cdot e^{b \cdot e^{c}} \right )$.  In the fluid flow literature, nested logarithms $ln(ln(a))$ are more common. 
