...
This encouraged us to add some exponential and logarithmic terms:
...
This showed us that the regularization *was* needed when vanilla linear regression is used for symbolic regression.

### AI Statement

No generative AI products were used in the writing of this paper.  Accordingly, the reader will encounter a shameless mixture of American and British spelling and idioms.

However, AI *was* used to coax recalcitrant libraries to stop throwing error codes and actually produce something useful.  Fortunately for the reader, this was only partially successful, or this paper would be a lot longer.
...
Maybe it is appropriate at this juncture to include a formal statistical test:
...
Shapiro-Wilk Statistic: 0.932714

Shapiro-Wilk p-Value: 0.001

Conclusion: We will reject the null hypothesis as the calculated p-value is less than the level of significance.
